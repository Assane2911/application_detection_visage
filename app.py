...
try:
    ...
    if face_cascade.empty():
        st.error(
            "Erreur: Le fichier 'haarcascade_frontalface_default.xml' n'a pas pu être chargé. Assurez-vous qu'il est disponible dans le chemin d'accès d'OpenCV.")
...
if uploaded_file is not None and face_cascade is not None:
    ...
    st.error(
        "L'application ne peut pas fonctionner car le classifieur de visages n'a pas pu être chargé. Veuillez vérifier l'installation d'OpenCV.")